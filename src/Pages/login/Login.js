            ...
            <div className="relative  z-10">
                ...
                <div class="container flex flex-col items-center justify-center min-h-screen px-6 mx-auto">
                    <div class="flex justify-center mx-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="currentColor" class="bi bi-android2 text-rose-700" viewBox="0 0 16 16">
                    ...
                    <h1 class="mt-4 text-2xl font-semibold tracking-wide text-center text-slate-200 capitalize md:text-3xl">
                        Login
                    </h1>
                    ...
                    <div class="w-full max-w-lg mx-auto mt-6 ">
                        <form className="space-y-8">
                            ...
                            <button class="  mx-auto max-w-xs px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-800 rounded-lg hover:bg-blue-400 flex justify-center items-center gap-4">
                            ...
                            <div class="mt-6 text-center">
                                <Link to="/signup" class="text-sm text-slate-300 hover:underline dark:text-blue-400">
